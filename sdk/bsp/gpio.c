...
void gpio_set_high(const gpio_e gpio) {
    SCUM_GPIO_INPUT |= (1 << gpio);
}

void gpio_set_low(const gpio_e gpio) {
    SCUM_GPIO_INPUT &= ~(1 << gpio);
}

void gpio_toggle(const gpio_e gpio) {
    SCUM_GPIO_INPUT ^= (1 << gpio);
}
...
void gpio_10_set(void) {
    gpio_set_high(GPIO_10);
}
void gpio_10_clr(void) {
    gpio_set_low(GPIO_10);
}
...
void gpio_11_set(void) {
    gpio_set_high(GPIO_11);
}
void gpio_11_clr(void) {
    gpio_set_low(GPIO_11);
}
...
void gpio_12_set(void) {
    gpio_set_high(GPIO_12);
}
void gpio_12_clr(void) {
    gpio_set_low(GPIO_12);
}
